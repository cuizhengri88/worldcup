window.WORLDCUP_2026_DATA = {
  "teams": {
    "MEX": {
      ...
      "style": "? ?? ???? ?? ?? + ?? ?? ??",
      "summary": "개최국 이점과 안정적인 경기 운영이 강점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Raúl Rangel",
      ...
      "dataUpdate": {
        ...
        "updatedAt": "2026-06-05T16:30:00+08:00",
        "basis": "FIFA April 2026 ranking + final 26-player squad confirmation + completed pre-tournament friendlies through 2026-06-05.",
        "friendlyMatchesApplied": 2
      },
      "preTournamentFriendlies": {
        "matches": 2,
        "wins": 2,
        "draws": 0,
        "losses": 0,
    ...
    "KOR": {
      ...
      "style": "?? ?? + ???-??? ??? ?????? ??",
      "summary": "핵심 선수의 결정력과 전환 속도가 강점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Kim Seung-gyu",
    ...
    "CZE": {
      ...
      "style": "???? ?? ?? + ????",
      "summary": "피지컬과 세트피스에서 변수를 만들 수 있다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Matěj Kovář",
    ...
    "SUI": {
      ...
      "style": "?? ?? ?? + ???? ???",
      "summary": "균형 잡힌 전력과 토너먼트 경험이 좋다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ?? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Gregor Kobel",
    ...
    "CAN": {
      ...
      "style": "?? ?? ?? + ?? ?? ??",
      "summary": "측면 속도와 역습 전개가 위협적이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Dayne St. Clair",
    ...
    "BRA": {
      ...
      "style": "?? ??? ?? ??? + ?? ???",
      "summary": "2026 월드컵 최종 26인 명단 기준으로 공격진의 폭발력과 수비진의 안정감이 모두 강한 우승 후보권 전력이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Alisson",
    ...
    "MAR": {
      ...
      "style": "?? ?? + ?? ?? ??",
      "summary": "수비 조직력과 집중력이 매우 좋다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ?? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Yassine Bounou",
    ...
    "SCO": {
      ...
      "style": "?? ??? + ??? ??",
      "summary": "에너지와 압박 강도가 장점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Angus Gunn",
    ...
    "USA": {
      ...
      "style": "?? ??? + ?? ??",
      "summary": "젊은 선수층과 홈 이점이 돋보인다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Matt Turner",
    ...
    "TUR": {
      ...
      "style": "??? ???? ?? + ?? ??",
      "summary": "중원의 기술과 공격 전개가 매력적이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Mert Günok",
    ...
    "AUS": {
      ...
      "style": "???? ???? + ?? ??",
      "summary": "끈질긴 수비와 공중볼 싸움에 강하다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Mathew Ryan",
    ...
    "GER": {
      ...
      "style": "?????? ?? + ?? ?? ??",
      "summary": "중원 장악력과 공격 옵션이 풍부하다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ?? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Manuel Neuer",
    ...
    "ECU": {
      ...
      "style": "?? ??? + ?? ??",
      "summary": "활동량과 수비 전환이 좋다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "CIV": {
      ...
      "style": "??? ?? + ???? ??",
      "summary": "전방의 힘과 속도로 변수를 만든다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Yahia Fofana",
    ...
    "NED": {
      ...
      "style": "?? ??? + ?? ????",
      "summary": "수비 안정감과 후방 빌드업이 강점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "JPN": {
      ...
      "style": "?? ??? ?? ?? + ?? ??",
      "summary": "팀 조직력과 짧은 패스 전개가 좋다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Zion Suzuki",
    ...
    "SWE": {
      ...
      "style": "??? ??? + ??? ??",
      "summary": "공중볼과 결정력에서 강점을 가진다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "BEL": {
      ...
      "style": "2? ??? + ?? ?? ?? ??",
      "summary": "공격진의 경험과 한 방이 강하다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ?? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "IRN": {
      ...
      "style": "???? ?? + ?? ??",
      "summary": "촘촘한 수비와 역습 완성도가 있다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "ESP": {
      ...
      "style": "???? ?? ?? + ?? ??",
      "summary": "중원 장악과 패스 템포가 세계 최상위권이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "David Raya",
    ...
    "URU": {
      ...
      "style": "?? ?? + ???? ?? ??",
      "summary": "중원 에너지와 공격 전환이 날카롭다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Sergio Rochet",
    ...
    "NOR": {
      ...
      "style": "?? ????? ?? + ?? ??",
      "summary": "최전방 결정력과 창의적인 패스가 강점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ?? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Ørjan Nyland",
    ...
    "SEN": {
      ...
      "style": "???? ?? ?? + ?? ??",
      "summary": "수비 힘과 역습 속도가 좋다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Yehvann Diouf",
    ...
    "ARG": {
      ...
      "style": "?? ??? + ?? ?? ?? ??",
      "summary": "토너먼트 운영과 승부처 집중력이 뛰어나다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ?? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Juan Musso",
    ...
    "AUT": {
      ...
      "style": "???? ?? + ?? ?? ??",
      "summary": "팀 단위 압박과 전술 수행력이 좋다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ?? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "POR": {
      ...
      "style": "2? ??? + ??-?? ??",
      "summary": "선수층과 공격 선택지가 매우 풍부하다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Diogo Costa",
    ...
    "COL": {
      ...
      "style": "?? ??? + ?? ??",
      "summary": "전방 개인 능력과 경기 흐름 전환이 좋다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "David Ospina",
    ...
    "ENG": {
      ...
      "style": "?? ?? ?? + ????",
      "summary": "전 포지션의 체급과 선수층이 강하다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "CRO": {
      ...
      "style": "?? ??? ?? ?? + ?? ?? ??",
      "summary": "노련한 경기 운영과 중원 패스가 장점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "GHA": {
      ...
      "style": "???? ?? + ???",
      "summary": "속도와 개인 돌파로 경기 흐름을 흔든다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "FRA": {
      ...
      "style": "?? ??? + ?? ??? ??",
      "summary": "공격 결정력과 선수층이 이번 대회 최상위권이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Brice Samba",
    ...
    "RSA": {
      ...
      "style": "?? ?? ?? + ?? ?? ??",
      "summary": "기동력과 전환 속도로 변수를 만든다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "BIH": {
      ...
      "style": "?? ??? + ????",
      "summary": "베테랑 공격진과 세트피스가 강점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Nikola Vasilj",
    ...
    "QAT": {
      ...
      "style": "?? ?? + ???? ?? ??",
      "summary": "조직적인 전개와 경기 운영이 장점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Mahmud Abunada",
    ...
    "HAI": {
      ...
      "style": "???? ?? + ?? ??",
      "summary": "빠른 전진과 개인 돌파로 기회를 노린다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Johny Placide",
    ...
    "PAR": {
      ...
      "style": "??? ?? + ????",
      "summary": "수비 집중력과 남미 특유의 끈질김이 강점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "CUW": {
      ...
      "style": "????? ??? + ?? ?? ?? ??",
      "summary": "활동량과 전환 플레이로 이변을 노린다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Eloy Room",
    ...
    "TUN": {
      ...
      "style": "???? ?? ?? + ??? ??",
      "summary": "수비 조직력과 경기 운영이 안정적이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Mouhib Chamakh",
    ...
    "EGY": {
      ...
      "style": "?? ??? ??? + ?? ??",
      "summary": "살라를 중심으로 한 역습과 결정력이 위협적이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "NZL": {
      ...
      "style": "???? ???? + ?? ??",
      "summary": "높이와 세트피스에서 변수를 만들 수 있다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Max Crocombe",
    ...
    "CPV": {
      ...
      "style": "??? ?? ?? + ?? ??",
      "summary": "빠른 측면 공격과 조직력으로 경쟁한다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Vozinha",
    ...
    "KSA": {
      ...
      "style": "??? ?? + ?? ?? ??",
      "summary": "빠른 전환과 경기 운영이 장점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Nawaf Al-Aqidi",
    ...
    "IRQ": {
      ...
      "style": "??? ?? ?? + ?? ???",
      "summary": "끈질긴 수비와 세트피스에서 기회를 만든다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Fahad Talib",
    ...
    "ALG": {
      ...
      "style": "??? 2? + ?? ??",
      "summary": "개인 기술과 공격 전개의 창의성이 좋다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Melvin Mastil",
    ...
    "JOR": {
      ...
      "style": "?? ??? ?? + ?? ??",
      "summary": "전환 속도와 측면 돌파로 기회를 만든다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
    ...
    "COD": {
      ...
      "style": "???? ?? ?? + ?? ??",
      "summary": "강한 피지컬과 빠른 전진 플레이가 돋보인다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Lionel Mpasi",
    ...
    "UZB": {
      ...
      "style": "?? ??? + ?? ??",
      "summary": "안정적인 중원 운영과 조직력이 장점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Utkir Yusupov",
    ...
    "PAN": {
      ...
      "style": "???? ?? + ?? ???",
      "summary": "수비 집중력과 끈질긴 경기 운영이 강점이다. 2026? 6? 5? ?? ?? ????? ?? 26? ??? ??? ?? ???? ????.",
      "squad": [
        {
          "number": 1,
          "name": "Luis Mejía",
  ...
  "teamMetrics": {
    "generatedAt": "2026-06-05T16:30:00+08:00",
    "modelVersion": "2026-06-05-pre-world-cup-refresh",
    "sources": [
      {
        "name": "FIFA/Coca-Cola Men's World Ranking",
        "url": "https://inside.fifa.com/fifa-world-ranking/men?dateId=id13678",
        "note": "Last official update 2026-04-01; next official update listed by FIFA as 2026-06-11 on the ranking page."
      },
      {
        "name": "FIFA World Cup 2026 squads confirmed",
        "url": "https://inside.fifa.com/organisation/media-releases/world-cup-2026-48-squads-confirmed",
        "note": "FIFA confirmed 48 squads and 1,248 players on 2026-06-02 after final squad submission."
      },
      {
        "name": "World Cup Ranking official squad list index",
        "url": "https://worldcupranking.com/world-cup-2026/squads/",
        "note": "Mirrors FIFA official 26-player lists for all 48 teams, published 2026-06-03."
      },
      {
        "name": "The Kenya Times international friendlies tracker",
        "url": "https://thekenyatimes.com/sports/fifa-international-friendlies-2026-live-scores-results-and-fixtures-today/",
        "note": "Completed international friendly results through early 2026-06-05 were used for short-term form."
      }
    ],
    "teams": {
      "MEX": {
        ...
        "analysisBasis": "FIFA April 2026 ranking + FIFA final squad confirmation + completed pre-tournament friendlies through 2026-06-05 + local squad/player quality model",
        "tacticalPower": 91,
        "managerTacticalProfile": {
          "managerModel": "??/?? ?? ?? ???",
          "notes": [
            "? ?? ???? ?? ??",
            "?? ?? ??"
        ...
        "lastDataUpdate": "2026-06-05T16:30:00+08:00",
        "dataCutoffDate": "2026-06-05"
      },
      "KOR": {
    ...
    "updateSummary": {
      "cutoffDate": "2026-06-05",
      "teamsUpdated": 48,
      "friendlyMatchesApplied": 34,
      "officialSquadBasis": "Final 26-player squads confirmed by FIFA; existing roster tables retained and condition/form values refreshed.",
      "rankingBasis": "FIFA 2026-04-01 official ranking remains the latest official ranking available before the 2026-06-11 update."
    }
  },
  "updateHistory": {
    "updates": [
      {
        "updatedAt": "2026-06-05T16:30:00+08:00",
        "cutoffDate": "2026-06-05",
        "title": "Pre-World Cup 2026 data refresh",
        "changedFiles": [
          "data/teams.json",
          "data/team-metrics.json",
          "js/bracket-data.js",
        ...
        "methodology": "???? ???, ??, ?? ??? ?? recentForm? 45% ???? ??, ?? 26? ?? ?? squad ???? depth/playerQuality? ?????. ?? ?? form? ? form ???? ????? ????.",
        "upcomingFriendlies": [
          {
            "date": "2026-06-06",
            "kickoff": "00:00",
            "kickoffLabel": "Jun 6 00:00 UK / Jun 6 07:00 China",
            "home": "Puerto Rico",
            "away": "KSA",
            "status": "scheduled"
          },
          {
            "date": "2026-06-06",
            "kickoff": "00:30",
            "kickoffLabel": "Jun 6 00:30 UK / Jun 6 07:30 China",
            "home": "CAN",
          ...
          },
          {
            "date": "2026-06-06",
            "kickoff": "01:00",
            "kickoffLabel": "Jun 6 01:00 UK / Jun 6 08:00 China",
            "home": "HAI",
            "away": "Peru",
            "status": "scheduled"
          },
          {
            "date": "2026-06-06",
            "kickoff": "14:00",
            "kickoffLabel": "Jun 6 14:00 UK / Jun 6 21:00 China",
            "home": "BEL",
            "away": "TUN",
            "status": "scheduled"
          },
          {
            "date": "2026-06-06",
            "kickoff": "18:45",
            "kickoffLabel": "Jun 6 18:45 UK / Jun 7 01:45 China",
            "home": "POR",
            "away": "Chile",
            "status": "scheduled"
          },
          {
            "date": "2026-06-06",
            "kickoff": "20:00",
            "kickoffLabel": "Jun 6 20:00 UK / Jun 7 03:00 China",
            "home": "USA",
            "away": "GER",
            "status": "scheduled"
          },
          ...
          },
          {
            "date": "2026-06-06",
            "kickoff": "21:00",
            "kickoffLabel": "Jun 6 21:00 UK / Jun 7 04:00 China",
            "home": "Bolivia",
            "away": "SCO",
            "status": "scheduled"
          },
          ...
          },
          {
            "date": "2026-06-06",
            "kickoff": "23:00",
            "kickoffLabel": "Jun 6 23:00 UK / Jun 7 06:00 China",
            "home": "BRA",
            "away": "EGY",
            "status": "scheduled"
          },
          ...
          },
          {
            "date": "2026-06-07",
            "kickoff": "01:00",
            "kickoffLabel": "Jun 7 01:00 UK / Jun 7 08:00 China",
            "home": "ARG",
            "away": "Honduras",
            "status": "scheduled"
          },
          {
            "date": "2026-06-07",
            "kickoff": "19:45",
            "kickoffLabel": "Jun 7 19:45 UK / Jun 8 02:45 China",
            "home": "CRO",
            "away": "Slovenia",
            "status": "scheduled"
          },
          {
            "date": "2026-06-07",
            "kickoff": "20:00",
            "kickoffLabel": "Jun 7 20:00 UK / Jun 8 03:00 China",
            "home": "MAR",
            "away": "NOR",
            "status": "scheduled"
          },
          {
            "date": "2026-06-07",
            "kickoff": "21:00",
            "kickoffLabel": "Jun 7 21:00 UK / Jun 8 04:00 China",
            "home": "ECU",
            "away": "Guatemala",
            "status": "scheduled"
          },
          {
            "date": "2026-06-08",
            "kickoff": "00:00",
            "kickoffLabel": "Jun 8 00:00 UK / Jun 8 07:00 China",
            "home": "COL",
            "away": "JOR",
            "status": "scheduled"
          },
          {
            "date": "2026-06-08",
            "kickoff": "19:45",
            "kickoffLabel": "Jun 8 19:45 UK / Jun 9 02:45 China",
            "home": "NED",
            "away": "UZB",
            "status": "scheduled"
          },
          {
            "date": "2026-06-08",
            "kickoff": "20:10",
            "kickoffLabel": "Jun 8 20:10 UK / Jun 9 03:10 China",
            "home": "FRA",
          ...
          },
          {
            "date": "2026-06-09",
            "kickoff": "03:00",
            "kickoffLabel": "Jun 9 03:00 UK / Jun 9 10:00 China",
            "home": "Peru",
            "away": "ESP",
            "status": "scheduled"
          },
          {
            "date": "2026-06-09",
            "kickoff": "16:00",
            "kickoffLabel": "Jun 9 16:00 UK / Jun 9 23:00 China",
            "home": "COD",
            "away": "Chile",
            "status": "scheduled"
          },
          {
            "date": "2026-06-10",
            "kickoff": "00:00",
            "kickoffLabel": "Jun 10 00:00 UK / Jun 10 07:00 China",
            "home": "KSA",
            "away": "SEN",
            "status": "scheduled"
          },
          {
            "date": "2026-06-10",
            "kickoff": "01:00",
            "kickoffLabel": "Jun 10 01:00 UK / Jun 10 08:00 China",
            "home": "Bolivia",
            "away": "ALG",
            "status": "scheduled"
          },
          {
            "date": "2026-06-10",
            "kickoff": "02:00",
            "kickoffLabel": "Jun 10 02:00 UK / Jun 10 09:00 China",
            "home": "ARG",
            "away": "Iceland",
            "status": "scheduled"
          },
          ...
          },
          {
            "date": "2026-06-10",
            "kickoff": "20:45",
            "kickoffLabel": "Jun 10 20:45 UK / Jun 11 03:45 China",
            "home": "POR",
            "away": "Nigeria",
            "status": "scheduled"
          },
          {
            "date": "2026-06-10",
            "kickoff": "21:00",
            "kickoffLabel": "Jun 10 21:00 UK / Jun 11 04:00 China",
            "home": "ENG",
            "away": "Costa Rica",
            "status": "scheduled"
          }
        ],
        "upcomingFriendliesSource": {
          "name": "Sports Mole and Sky Sports international friendlies fixtures",
          "note": "Upcoming friendlies listed before the 2026 World Cup opener; kickoff labels keep the published UK time and add China time conversion.",
          "cutoff": "Through Jun 10 2026 21:00 UK / Jun 11 2026 04:00 China"
        }
      }
    ]
  }
